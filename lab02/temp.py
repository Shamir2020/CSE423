...
def drawControlsBtns():
    ...
    topLeft = mid_point2.MidPointLineDrawing(-95,280,-85,290)
    drawLine(topLeft, 3)
    bottomLeft = mid_point2.MidPointLineDrawing(-95, 280, -85, 270)
    drawLine(bottomLeft,3)
    middleLine = mid_point2.MidPointLineDrawing(-95,280,-80,280)
    drawLine(middleLine, 3)

    # Draw Pause button 
    glColor3f(1, 0.65098,0)
    if pause:
        topLeft = mid_point2.MidPointLineDrawing(-5,282.5,3,294)
        drawLine(topLeft,3)
        bottomLeft = mid_point2.MidPointLineDrawing(-5,282.5,3,270)
        drawLine(bottomLeft,3)
        right = mid_point2.MidPointLineDrawing(3,270,3,294)
        drawLine(right,3)
    else:
        pauseLeft = mid_point2.MidPointLineDrawing(-3,295,-3,270)
        drawLine(pauseLeft, 3)
        pauseRight = mid_point2.MidPointLineDrawing(3,295,3,270)
        drawLine(pauseRight, 3)

    #Draw close button 
    glColor3f(1,0,0)
    closeLeft = mid_point2.MidPointLineDrawing(85, 295, 95, 270)
    drawLine(closeLeft, 3)
    closeRight = mid_point2.MidPointLineDrawing(85, 270, 95,295)
...
def drawPlayer():
    ...
    coordinatesUp = mid_point2.MidPointLineDrawing(-20+playerOffset,-260,20+playerOffset,-260)
    drawLine(coordinatesUp, 4)
    coordinatesDown = mid_point2.MidPointLineDrawing(-16+playerOffset,-280,16+playerOffset,-280)
    drawLine(coordinatesDown, 4)
    cordinatesLeft = mid_point2.MidPointLineDrawing(-16+playerOffset,-280,-20+playerOffset,-260)
    drawLine(cordinatesLeft, 4)
    cordinatesRight = mid_point2.MidPointLineDrawing(16+playerOffset,-280,20+playerOffset,-260)
...
def drawIdleEnemy():
    ...
    if gameOver:
        ...
        glColor3f(a,b,c)
        bottomRight = mid_point2.MidPointLineDrawing(left,260-dropOffset,left+5,275-dropOffset)
        drawLine(bottomRight, 3)

        topRight = mid_point2.MidPointLineDrawing(left+5,275-dropOffset,left,290-dropOffset)
        drawLine(topRight, 3)

        topLeft = mid_point2.MidPointLineDrawing(left,290-dropOffset,left-5,275-dropOffset)
        drawLine(topLeft, 3)
    
        bottomLeft = mid_point2.MidPointLineDrawing(left-5,275-dropOffset,left,260-dropOffset)
        drawLine(bottomLeft, 3)
