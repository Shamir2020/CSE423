...
class Game:
    ...
    def display(self):
        ...
        if self.boss:
            if self.is_point_inside(self.bomb[0],self.bomb[1]-2,".."):
                self.collision+=1
                print(self.collision)
                self.bomb[1] = self.ship3_y
...
#                     self.ship8_speed += 0.2
        ...
        interval = 0
        if (self.score > 6+interval and self.score < 28+interval) :
            self.boss = True
            interval += 50
