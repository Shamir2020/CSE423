...
class Game:
    ...
    def display(self):
        ...
        for bullet in self.bullets:
            ...
            if not self.boss:
                if self.has_collided([bullet[0], bullet[1], 0, 0],
                    ...
                    if self.hit_count_ship1 == 20 and self.playerno == 1:
                        self.score += 1
                    ...
                    elif self.hit_count_ship1 == 16 and self.playerno == 2:
                        self.score += 1
                        print("Score:", self.score)
                        self.hit_count_ship1 = 0
                        self.ship1_y = (self.WINDOW_HEIGHT - 20)
                        self.ship1_x = random.randint(1, self.WINDOW_WIDTH - self.SHIP_SIZE)
                        self.ship1_speed += 0.2
                    elif self.hit_count_ship1 == 10 and self.playerno == 3:
                        self.score += 1
                        print("Score:", self.score)
                        self.hit_count_ship1 = 0
                        self.ship1_y = (self.WINDOW_HEIGHT - 20)
            ...
            if not self.boss:
                if self.has_collided([bullet[0], bullet[1], 0, 0],
                    ...
                    self.bullets.remove(bullet)
                    if self.hit_count_ship2 == 20 and self.playerno == 1:
                        self.score += 1
                        print("Score:", self.score)
                        self.hit_count_ship2 = 0
                        if ((self.WINDOW_WIDTH//2)-50 <= self.ship1_x <= (self.WINDOW_WIDTH//2)+50) or (self.ship1_x == (self.WINDOW_WIDTH//2 )):
                    ...
                    elif self.hit_count_ship2 == 15 and self.playerno == 2:
                        self.score += 1
                        print("Score:", self.score)
                        self.hit_count_ship2 = 0
                        if ((self.WINDOW_WIDTH//2)-50 <= self.ship1_x <= (self.WINDOW_WIDTH//2)+50) or (self.ship1_x == (self.WINDOW_WIDTH//2 )):
                        ...
                        self.ship2_y = (self.WINDOW_HEIGHT - 20)
                        self.ship2_speed += 0.2
                    elif self.hit_count_ship2 == 10 and self.playerno == 3:
                        self.score += 1
                        print("Score:", self.score)
                        self.hit_count_ship2 = 0
                        if ((self.WINDOW_WIDTH//2)-50 <= self.ship1_x <= (self.WINDOW_WIDTH//2)+50) or (self.ship1_x == (self.WINDOW_WIDTH//2 )):
            ...
            if self.boss:
                if self.has_collided([bullet[0], bullet[1], 0, 0],
                    ...
                    if self.hit_count_ship3 == 350 and self.playerno == 1: 
                       self.score += 20
                       print(self.score)
                       self.hit_count_ship3 = 0
                       self.boss = False
                    elif self.hit_count_ship3 == 300 and self.playerno == 1:
                        self.score += 20
                        print(self.score)
                        self.hit_count_ship3 = 0
                        self.boss = False
                    elif self.hit_count_ship3 == 200 and self.playerno == 1:
                        self.score += 20
                        print(self.score)
                        self.hit_count_ship3 = 0
                        self.boss = False

            # Check collision with the 4th enemy ship
            if not self.boss:
                if self.has_collided([bullet[0], bullet[1], 0, 0],
                                    [self.ship6_x, self.ship6_y - self.SHIP_SIZE, self.SHIP_SIZE, self.SHIP_SIZE]):
                    
                    self.hit_count_ship6 += 1
                    if self.playerno == 1 and self.hit_count_ship6 == 20:
                        self.score += 5
                        print("Score:", self.score)
                        self.hit_count_ship6 = 0
                    ...
                    elif self.playerno == 2 and self.hit_count_ship6 == 15:
                        self.score += 5
                        print("Score:", self.score)
                        self.hit_count_ship6 = 0
                        self.ship6_y = (self.WINDOW_HEIGHT - 20)
                        self.ship6_x = random.randint(1, self.WINDOW_WIDTH - self.SHIP_SIZE)
                        self.ship6_speed += 0.2
                    elif self.playerno == 3 and self.hit_count_ship6 == 10:
                        self.score += 5
                        print("Score:", self.score)
                        self.hit_count_ship6 = 0
                        self.ship6_y = (self.WINDOW_HEIGHT - 20)
        ...
        if self.boss:
            if self.is_point_inside(self.bomb[0], self.bomb[1] - 2, "..") and self.collision < 5:
                if not self.has_collided([self.player_x, self.player_y, self.PLAYER_WIDTH, self.PLAYER_HEIGHT],
                                        [self.bomb[0], self.bomb[1], 10, 10]):
                    self.collision += 1
        ...
        #midpoint_cir.filled_circle(56,self.player_x+16, self.player_y-56)
